  ...
  return (
    <div id="Landing">
      <section className="sect1">
        ...
        <p>
          더 <span>스마트</span>한 이동
        </p>
        <p>
          <span>당근마차</span>에서 시작됩니다
        </p>
        <Link to="/main" className="btn-trial">
          체험해보기
        </Link>
      </section>
      <section className="sect2"></section>
      <section className="sect3">
		<img src="/img/sect3.png" alt="section3 img" />
	  </section>
      <section className="sect4">
        <p className={`typing-text ${isTypingComplete[0] ? "completed" : ""}`}>
          {texts[0]}
        </p>
      </section>
      <section className="sect5">
        <p className={`typing-text ${isTypingComplete[1] ? "completed" : ""}`}>
          {texts[1]}
        </p>
      </section>
      <section className="sect6">
		<img src="/img/people.png" alt="waiting people" />
      ...
      <section className="sect7">
        <p>그런 여러분들을 위해서 <span>당근</span>이 <span>마차</span>를준비했습니다 😉</p>
      </section>
    </div>
  );
}
